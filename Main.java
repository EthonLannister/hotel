...
public class Main {
    public static void main(String[] args) {
     //key 测试旅馆创建
        ...
        //key 检测升级降级
        System.out.println("\n");
        System.out.println(rm1.getUpgradeMap(rs6));
        System.out.println(rm1.getDowngradeMap(rs6));
        System.out.println(rm1.getUpgradeMap(rs8));
        System.out.println(rm1.getDowngradeMap(rs8));
